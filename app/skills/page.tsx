...
const skills = {
  ...
  "AI & ML Technologies": [
    { name: "OpenAI API", icon: <TbBrain className="text-[#00A3A3]" /> },
    { name: "TensorFlow", icon: <TbBrain className="text-[#FF6B6B]" /> },
    { name: "PyTorch", icon: <TbBrain className="text-[#EE4C2C]" /> },
    { name: "Google Vertex AI", icon: <TbBrain className="text-[#4285F4]" /> },
  ],
  "Tools & Technologies": [
