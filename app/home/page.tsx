      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 max-w-7xl w-full py-8 md:py-0">
            ...
            <div className="relative w-40 h-40 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-72 lg:h-72">
              ...
              >
                <div className="relative w-full h-full">
                  <Image
                    src="/gaurav_patil.jpg"
                    alt="Profile"
                    fill
                    className={`object-cover rounded-full p-2 transition-opacity duration-100 ${isGlitching ? "opacity-0" : "opacity-100"
                      }`}
                    priority
                  />
                  <Image
                    ...
                    alt="Profile Glitch"
                    fill
                    className={`object-cover rounded-full p-2 transition-opacity duration-100 ${isGlitching ? "opacity-100" : "opacity-0"
                      }`}
                    priority
                  />
                </div>
        ...
        >
          ...
          >
            ...
            Full-stack developer who enjoys building digital puzzles and occasionally solving them.
            Exploring AI to make machines think—it’s a fun challenge. 🚀
          </motion.p>
